...
function build_images() {
  ...
  oc process -f https://raw.githubusercontent.com/jbossdemocentral/coolstore-microservice/stable-ocp-3.10/openshift/templates/coolstore-builds-template.yaml \
  ...
  oc create -f https://raw.githubusercontent.com/openshift-labs/devops-labs/ocp-3.10/lab-6/coolstore-template.yaml -n openshift --as=system:admin
}
